...
\begin{center}
    {\Huge \scshape Yubin Lee} \\ \vspace{1pt}
    E3-1 4xxx, 291, Daehak-ro, Yuseong-gu, Daejeon, Republic of Korea 34141 \\ \vspace{1pt}
    \small \raisebox{-0.1\height}\faPhone\ 123-456-7890 ~ \href{mailto:727yubin@kaist.ac.kr}{\raisebox{-0.2\height}\faEnvelope\  \underline{727yubin@kaist.ac.kr}} ~ 
    \href{https://linkedin.com/in/727yubin/}{\raisebox{-0.2\height}\faLinkedin\ \underline{linkedin.com/in/727yubin}}  ~
    \href{https://github.com/727yubin}{\raisebox{-0.2\height}\faGithub\ \underline{github.com/727yubin}}
    \vspace{-8pt}
\end{center}
